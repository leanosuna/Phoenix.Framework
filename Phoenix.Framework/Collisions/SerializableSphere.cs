...
{
    public class SerializableSphere : SerializableVolume
    {
        ...
        public new static SerializableSphere Deserialize(JsonObject data)
        {
            return new SerializableSphere
            {
        ...
        public static implicit operator BoundingSphere(SerializableSphere v)
            => new(v.Position, v.Radius);
    }
}
